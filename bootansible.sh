...
sudo apt update && apt-add-repository --yes --update ppa:ansible/ansible && sudo apt -y install curl wget net-tools iputils-ping python3-pip sshpass software-properties-common ansible
